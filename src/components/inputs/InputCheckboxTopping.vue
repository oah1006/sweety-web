<template>
  <form class="w-full relative mt-2">
    <div :class="[checkNames.includes(props.idTopping) ? 'bg-orange-50' : '']" class="w-full text-orange-900 rounded-lg border border-orange-300 py-2 lg:flex lg:items-center gap-10 grow px-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <p class="lg:text-lg text-sm text-center flex-none">{{ props.name }}</p>
      </div>
