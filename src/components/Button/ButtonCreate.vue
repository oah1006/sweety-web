<template>
  <button v-show="profileStore.profile.profile?.role === 'administrator'" @click="clickRedirect" class="flex gap-3 items-center px-4 py-2 text-white text-center bg-orange-500 rounded-xl">
