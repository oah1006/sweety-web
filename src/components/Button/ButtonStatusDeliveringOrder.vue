<template>
  <button @click="changeStatusDeliveringOrder" class="flex gap-3 items-center px-4 py-2 text-white text-center bg-violet-500 rounded-xl">
...
import { useUpdateStatusDeliveringOrderApi } from "@/repositories/order";
