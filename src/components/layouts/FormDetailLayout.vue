  ...
  <div class="grow lg:px-10 lg:py-6">
    <div class="flex items-center">
      ...
      <div class="flex gap-3 ml-auto items-center">
        <button @click="useClickRedirectUpdate(props.itemId)" class="text-xl bg-orange-500 text-white px-2 py-2 lg:py-3 lg:px-3 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" class="lg:h-6 lg:w-6 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
          </svg>
        </button>
        <a method="post" class="flex items-center text-xl bg-white px-2 py-2 lg:py-3 lg:px-3 rounded-lg text-red-500">
            <button type="submit">
                <svg xmlns="http://www.w3.org/2000/svg" class="lg:h-6 lg:w-6 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
