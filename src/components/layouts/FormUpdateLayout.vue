  ...
  <form>
    ...
    <div class="flex my-8">
      <div class="flex items-center gap-3">
        <a type="button" @click="redirectIndex" class="cursor-pointer font-medium text-lg inline-flex items-center rounded-md bg-white text-black px-4 py-2 shadow-lg hover:bg-zinc-50 gap-3">
