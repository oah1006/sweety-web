<template>
  <div v-if="props.total > 0" class="ml-64 mt-28">
    <div class="flex items-center">
      <TitlePage title="Nhân viên" sub-title="Đây là danh sách của nhân viên các cửa hàng chúng ta!" />
      <Button nameButton="Tạo mới" class="ml-auto mr-12" @click-redirect-create="useClickRedirectCreate"/>
    </div>
...
const emits = defineEmits(['delete-item', 'click-redirect-create', 'click-redirect-update-staff', 'pre-page', 'next-page'])
