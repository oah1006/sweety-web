                ...
                <table class="w-full bg-white rounded-lg border-t">
                    ...
                    <tbody>
                        <tr class="text-zinc-600 border-b text-sm">
                            ...
                            <td class="px-4 py-4 text-orange-400 font-bold">NV001</td>
                            <td class="px-4 py-4">Hào</td>
                            <td class="px-4 py-4">Bnhao10062001@gmail.com</td>
                        ...
                        <tr class="text-zinc-600 border-b text-sm">
                            ...
                            <td class="px-4 py-4">Sweety 1</td>
                            <td class="px-4 py-4">
                                <p class="inline-block text-center text-xs text-white px-2 py-0.5 bg-blue-400 rounded-lg">Nhân viên</p>
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-blue-500">
